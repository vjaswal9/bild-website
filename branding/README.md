...
**Strapline:** Building Legacy. Inspiring Growth. Living Purpose.
...
| Premium Gold | `#C8A64B` | 200, 166, 75 | Lead accent, crown, highlights |
| Ivory | `#F4F1EC` | 244, 241, 236 | Light backgrounds, reversed text |
| Stone Grey | `#D9D7D2` | 217, 215, 210 | Supporting neutral |

## Typography

- **Playfair Display** (Bold) - headlines and the logo wordmark
- **Montserrat** (Regular / Medium) - body copy and supporting text
