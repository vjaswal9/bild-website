  ...
  return (
    <div className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading title="Photo Vault" subtitle="Memories from BILD events and celebrations" />
        ...
        {filtered.length === 0 ? (
          ...
          <div className="columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
            {filtered.map(photo => (
              <div
                key={photo.id}
                className="break-inside-avoid cursor-pointer rounded-xl overflow-hidden bg-gray-100 hover:opacity-90 transition-opacity"
        ...
        {lightbox && (
          ...
          >
            <button className="absolute top-4 right-4 text-white hover:text-saffron-400 transition-colors">
              <X size={28} />
            </button>
            <div
